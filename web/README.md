# Amor In Formaturas — Gestão do Negócio

Sistema de gestão comercial e financeira da Amor In Formaturas: CRM de vendas, DRE, projeções e integração com o SGE. Publicado no Cloudflare Pages.
